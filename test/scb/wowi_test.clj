...
(deftest supports-multiple
  (testing "foo"
    (let [url "https://www.wowinterface.com/downloads/info24870-BFAInvasionTimer.html"
          fixture (->> "test/fixtures/wowinterface--addon-detail--supports-multiple.html"
                       fs/absolute
                       fs/normalized
                       str
                       (as-downloaded-item url))
          ...
          {:parsed [{:created-date "2018-12-15T09:53:00Z",
                     ...
                     :wowi/description [" Please support my work on Patreon/GitHub!"
                                        "Features Show timers for the next invasion and the current invasion duration."
                                        ...
                                        "Warning This addon will not work until you encounter your first invasion with it enabled."
                                        "Configure/bit"
                                        "/bfainvasiontimer"
