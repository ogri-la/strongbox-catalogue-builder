...
(s/def ::game-track #{:retail :classic :classic-tbc :classic-wotlk :classic-cata :classic-mists})
...
(s/def :addon/source #{:wowinterface :curseforge :github})
(s/def :addon/source-id (s/or ::integer-id? int?
                              ::string-id? string?))
